...
namespace Calc4Life.Behaviors
{
    /// <summary>
    /// Прикрепляемое поведение для добавления EntryLineColorEffect эффекта(окрашивает линию Entry контрола)
    /// Используется в валидации
    /// </summary>
