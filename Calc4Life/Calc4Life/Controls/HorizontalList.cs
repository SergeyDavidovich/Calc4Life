...
namespace Calc4Life.Controls
{
    public class HorizontalList : Grid
    {
        ...
        private readonly CustomScrollView _scrollView;
        ...
        //    BindableProperty.Create("IsScrollBarVisible", typeof(bool), typeof(HorizontalList), default(bool), BindingMode.TwoWay, propertyChanged: OnIsScrollBarVisibleChanged);
        ...
        {
            _scrollView = new CustomScrollView();
            ...
            _scrollView.IsHorizontalScrollbarEnabled = IsScrollBarVisible;
        ...
        private static void OnIsScrollBarVisibleChanged(BindableObject bindable, object oldValue, object newValue)
        {
            var itemsView = (HorizontalList)bindable;
            if (newValue == oldValue && newValue != null)
            {
            ...
            itemsView._scrollView.IsVisible = (bool)newValue;
